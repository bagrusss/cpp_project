...
#include "../../congratulations0/settingsmanager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SettingsManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 5)
    ...
    "SettingsManager\0editSettings\0\0count\0"
};
...
void SettingsManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->editSettings((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject SettingsManager::staticMetaObject = {
    { &Manager::staticMetaObject, qt_meta_stringdata_SettingsManager.data,
      qt_meta_data_SettingsManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingsManager.stringdata))
