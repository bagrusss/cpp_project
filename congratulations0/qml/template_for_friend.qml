...
Rectangle {
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                id: select_template_1
                x: 8
                y: 8
                width: 32
                height: 32
                MouseArea {
                    id: select_template_mousearea_1
                    x: 0
                    y: 0
                    width: 32
                    height: 32
                }
                source: "../src/ic_check.png"
            }
        ...
        Rectangle {
            ...
            radius: 0
            Image {
                id: select_template_2
                x: 8
                y: 8
                width: 32
                height: 32
                MouseArea {
                    id: select_template_mousearea_2
                    x: 0
                    y: 0
                    width: 32
                    height: 32
                }
                source: "../src/checked.png"
            }
        ...
        Rectangle {
            ...
            radius: 0
            Image {
                id: select_template_3
                x: 8
                y: 8
                width: 32
                height: 32
                MouseArea {
                    id: select_template_mousearea_3
                    x: 0
                    y: 0
                    width: 32
                    height: 32
        ...
        Rectangle {
            ...
            radius: 0
            Image {
                id: select_template_4
                x: 8
                y: 8
                width: 32
                height: 32
                MouseArea {
                    id: select_template_mousearea_4
                    x: 0
                    y: 0
                    width: 32
                    height: 32
