...
Item {
    ...
    property alias listView: templateList;
    property string mainWindowHeaderText;
    property string templatesIconImgPath;
    ...
    EditTemplateElement {
        ...
        function saveTemplate() {
            if (templateTextEdit.text != "Текст шаблона" && templateTitleEdit.text != "Заголовок шаблона") {
                templateMainListView.addTemplate(templateTitleEdit.text, templateTextEdit.text);
            }
            templateMainListView.state = " ";
        }
    ...
    ListView {
        ...
        Component.onCompleted: {
           mainWindow.headerText = mainWindowHeaderText// "Шаблон"
           footerMenu.templatesIconImg = templatesIconImgPath //"qrc:///src/templates_selected.png"
